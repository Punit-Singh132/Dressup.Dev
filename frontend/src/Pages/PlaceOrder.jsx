...
const PlaceOrder = () => {
  ...
  const options = {
    ...
    handler: async (response) => {
      ...
      // Add verification call here if needed
    },
    prefill: {
    ...
    try {
      ...
      switch (method) {
        ...
        case 'stripe':
          ...
          case 'razorpay':
  try {
    console.log("🟡 Razorpay block entered");
    console.log("📤 Sending Razorpay request", orderData);
    console.log("POST to:", backendUrl + "/api/order/razorpay");
    ...
    console.log("🟢 Razorpay order from backend:", responseRazorpay.data);

    if (responseRazorpay.data.success) {
      console.log("🟢 Calling initPay");
      initPay(responseRazorpay.data.order);
    } else {
      console.warn("🔴 Razorpay API response says failure:", responseRazorpay.data);
      toast.error("Razorpay order API failed");
    }
  } catch (err) {
    console.error("🔴 Error in Razorpay block:", err.response?.data || err.message || err);
    toast.error("Error placing Razorpay order");
  }
  break;
